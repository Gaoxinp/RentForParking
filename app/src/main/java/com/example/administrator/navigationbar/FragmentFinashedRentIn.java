...
public class FragmentFinashedRentIn extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_finashed_rentin, container, false);

        listView = (ListView) view.findViewById(R.id.listView_finashed_renIn);
...
//        listView.setAdapter(adapter);
    ...
    // : 2017/4/7  根据用户手机号从服务器获取用户 已完成——租入列表
    private void getDealDetail() {
        JsonObject object = new JsonObject();
        object.addProperty("Flag", "getFinashed_rentIn");
